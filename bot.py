...
# Configs
API_HASH = os.environ['a41d007169ca0f05f8cb99cd1b3273ec']
APP_ID = int(os.environ['34552415'])
BOT_TOKEN = os.environ['8556089916:AAEzxu5vFSsMs_qjTdltCZY7HqwJ2LN0p40']
TRACK_CHANNEL = int(os.environ['TRACK_CHANNEL'])
OWNER_ID = os.environ['8546199829']
